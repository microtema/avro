...
public class Message extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    private static final long serialVersionUID = -5687928231977153143L;
    public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Message\",\"namespace\":\"de.microtema.mail\",\"fields\":[{\"name\":\"to\",\"type\":\"string\"},{\"name\":\"from\",\"type\":\"string\"},{\"name\":\"body\",\"type\":\"string\"}]}");
     ...
     */
    public static de.microtema.mail.Message.Builder newBuilder() {
        return new de.microtema.mail.Message.Builder();
    }
     ...
     * @return A new Message RecordBuilder
     */
    public static de.microtema.mail.Message.Builder newBuilder(de.microtema.mail.Message.Builder other) {
        if (other == null) {
            return new de.microtema.mail.Message.Builder();
        } else {
            return new de.microtema.mail.Message.Builder(other);
        }
    }
     ...
     * @return A new Message RecordBuilder
     */
    public static de.microtema.mail.Message.Builder newBuilder(de.microtema.mail.Message other) {
        if (other == null) {
            return new de.microtema.mail.Message.Builder();
        } else {
            return new de.microtema.mail.Message.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Message>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(de.microtema.mail.Message.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(de.microtema.mail.Message other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.to)) {
                this.to = data().deepCopy(fields()[0].schema(), other.to);
         ...
         * @return This builder.
         */
        public de.microtema.mail.Message.Builder setTo(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public de.microtema.mail.Message.Builder clearTo() {
            to = null;
         ...
         * @return This builder.
         */
        public de.microtema.mail.Message.Builder setFrom(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public de.microtema.mail.Message.Builder clearFrom() {
            from = null;
         ...
         * @return This builder.
         */
        public de.microtema.mail.Message.Builder setBody(java.lang.CharSequence value) {
         ...
         * @return This builder.
         */
        public de.microtema.mail.Message.Builder clearBody() {
            body = null;
